...
Following the above steps, I got dataframe of 68 comuns and 180 rows.

Below is teh example of head(tidyData) for Subject id 1.
...
2. Variable Names with description
